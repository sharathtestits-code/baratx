"""BarathX topic taxonomy — 30 India-trending subtopics per arena (Path C).
...
TOPICS_BY_ARENA: dict[str, list[dict]] = {
    ...
    "politics": [
        ...
        {"key": "geopolitics", "name": "Geopolitics", "blurb": "India’s place in a contested world — daily debates.", "rss_query": "India geopolitics Indo-Pacific"},
    ...
    "news": [
        ...
        {"key": "geopolitics", "name": "Geopolitics", "blurb": "Borders, blocs, and power — daily India lens.", "rss_query": "India geopolitics foreign affairs"},
